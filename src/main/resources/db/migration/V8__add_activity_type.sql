...
VALUES ('user_login', 'User Login', 'User logged into their account.', 'Account'),
       ...
       ('user_restore', 'User Restored', 'User account was restored.', 'Account'),
       ('password_reset', 'Password Reset', 'User reset their password.', 'Account'),
       ('email_verification', 'Email Verification', 'User verified their email address.', 'Account'),
       ('two_factor_authentication', 'Two-Factor Authentication', 'User enabled two-factor authentication.', 'Account'),
       ('two_factor_deactivation', 'Two-Factor Deactivation', 'User disabled two-factor authentication.', 'Account'),
