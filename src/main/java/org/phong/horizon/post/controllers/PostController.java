...
public class PostController {
    ...
    @GetMapping()
    public ResponseEntity<List<PostRespond>> getAllPublicPostsByUserId(@RequestBody GetPostRequest request) {
        return ResponseEntity.ok(postService.getAllPublicPostsByUserId(request.userId()));
    }
}
