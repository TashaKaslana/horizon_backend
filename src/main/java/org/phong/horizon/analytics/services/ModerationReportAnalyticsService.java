...
public class ModerationReportAnalyticsService {
    ...
    public List<OverviewStatistic> getModerationOverviewStatistics() {
        ...
        // For the trend, we'll need to add a new method to the repository
        // This is an approximation based on weekly report counts
        ...
        // 2. Resolved Today
        // We'll need to add a method to repository to count by status and date range
        ...
        // Create and return the overview statistics
        return List.of(
